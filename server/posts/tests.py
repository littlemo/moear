...
class PostMetaSerializerTests(TestCase):
    def test_create(self):
        ...
        fake_data = fake_data_post
        fake_postmeta_data = fake_data.pop('meta')
        ...
        post, created = Post.objects.get_or_create(
            ...
            defaults=fake_data)
        log.debug('获取Post: {}， 创建: {}'.format(post, created))
        postmeta_serializer = PostMetaSerializer(
            data=fake_postmeta_data, many=True)
    ...
    def test_update(self):
        ...
        self.assertEqual(
            ...
            str(fake_postmeta_data[1]['value']))
